...
def randomFractal(N, r, K, sortBy='Euclidean', twoQuads=True, centered=False):
    '''
    Create the random fractal for image size N given the Katz criterion K
    ...
    kSpace = np.zeros((N,N))
    lines, angles, mValues = computeRandomLines(kSpace, anglesSorted, finiteAnglesSorted, r, K, centered, twoQuads)
    mu = len(lines)
    print("Number of finite lines in fractal:", mu)
