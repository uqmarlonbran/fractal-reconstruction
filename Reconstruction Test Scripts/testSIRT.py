# -*- coding: utf-8 -*-
"""
Test of SIRT using Shepp Logan phantom and squared fractal sampling
...
t = 150 # reduction factor 0.5
it = 300
#t = 75 # reduction factor 0.18
#it = 500

start = time.time()
recon, firstRecon = iterative.sirt_frt_complex(it, N, drtSpace, mValues, t, 2, 1, oversampleFilter=oversampleFilter)
end = time.time()
elapsed = end - start
